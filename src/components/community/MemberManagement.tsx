...
export const MemberManagement = ({ communityId }: MemberManagementProps) => {
  ...
  const handleBanMember = async (userId: string) => {
    if (
      !confirm(
        "Are you sure you want to ban this member? They will not be able to rejoin.",
      )
    )
      return;
  ...
  const handlePromoteModerator = async (
    ...
    try {
      ...
      toast({
        title:
          newRole === "moderator" ? "Member promoted" : "Moderator demoted",
              ...
              {member.role !== "admin" && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onClick={() =>
                        handlePromoteModerator(member.user_id, member.role)
                      }
                    >
