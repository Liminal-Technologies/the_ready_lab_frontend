...
const CertificationBadge = ({
  ...
  return (
    <Card
      className={`group transition-all duration-300 ${status === "earned" ? "ring-2 ring-success/20 hover:ring-success/40" : "hover:shadow-medium"}`}
    >
      <CardContent className={sizeClasses[size]}>
        <div className="flex items-start gap-3">
          <div
            className={`w-12 h-12 rounded-full flex items-center justify-center ${config.color} shadow-soft`}
          >
