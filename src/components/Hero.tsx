    ...
    <section className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 right-8 md:right-16 lg:right-24 z-20 max-w-sm hidden lg:block">
        <div className="rounded-2xl p-5 text-center">
          <p
            className="text-white mb-5 leading-relaxed font-normal"
            style={{
              fontSize: "0.9375rem",
              textShadow: "2px 2px 8px rgba(0,0,0,0.9)",
            }}
          >
            Build the fundable business that funders actually want to back. Real
            education, real results, real opportunity.
          </p>
