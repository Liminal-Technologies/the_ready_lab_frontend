...
const Features = () => {
  ...
  return (
    <>
      <section
        id="about"
        className="py-24 lg:py-32 bg-white transition-colors duration-200 overflow-hidden"
      >
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div>
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-4">
                  <span className="text-black">Why Choose The </span>
          ...
          <div className="bg-yellow-50/20 rounded-[3rem] p-8 lg:p-12">
 ...
 `}
                  ...
                  >
                    ...
                    {/* Card Content */}
                    <div>
                      <h3 className="text-2xl lg:text-3xl font-bold mb-4 text-neutral-900">
                        {feature.title}
                      </h3>
                    ...
                    <div className="absolute -bottom-8 -right-8 w-32 h-32 rounded-full bg-neutral-200/50/50 blur-3xl transition-all duration-300 group-hover:scale-150" />
                  </div>
                );
              })}
            </div>
      ...
      <section className="py-20 lg:py-32 bg-white transition-colors duration-200">
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          {/* Header */}
          <div className="mb-12 lg:mb-16">
            {/* Small Green Label */}
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-green-100/30 text-green-700 rounded-full text-sm font-semibold">
                Learning styles
              </span>
            </div>
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-6">
              ...
              <br />
              <span className="text-green-600">Learner</span>
            </h2>

            {/* Supporting Text */}
            <p className="text-xl md:text-2xl text-neutral-600 max-w-3xl">
              We know every learner is different — that's why The Ready Lab
              supports multiple learning styles to help you absorb, retain, and
              apply knowledge in real life.
            </p>
          </div>

          {/* Large Rounded Light Green Panel */}
          <div className="bg-green-50/20 rounded-[3rem] p-8 lg:p-12 mb-8">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 mb-6 lg:mb-8">
              ...
              <div
                ...
                data-testid="card-industry-experts"
              >
                <div className="mb-6">
                  <img
                    src={educatorImage}
                ...
                <div className="mb-4">
                  <span className="inline-block px-3 py-1 bg-green-100/30 text-green-700 rounded-full text-xs font-semibold mb-3">
                ...
                <p className="text-neutral-600 mb-6">
                  Our instructors are successful entrepreneurs and business
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 bg-green-100/30 rounded-full flex items-center justify-center flex-shrink-0">
