...
const mockLearningPaths = [
  {
    ...
    description:
      "Master grants, sponsorships, and investor pitches for sustainable funding",
    totalLessons: 24,
    completedLessons: 18,
  ...
  },
  {
    ...
    description:
      "Set up compliance, budgets, and operational systems funders demand",
    totalLessons: 20,
    completedLessons: 20,
  ...
  },
  {
    ...
    description:
      "Develop clear messaging that attracts investors and customers",
    totalLessons: 16,
    completedLessons: 8,
...
const LearningDashboard = () => {
  ...
  return (
    <section className="py-16 lg:py-24 bg-neutral-50 border-t border-neutral-100 transition-colors duration-200">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div className="text-center p-4 bg-success/5 rounded-lg">
                      <div className="font-semibold text-success mb-2">
                        {t("dashboard.credibilityBoost")}
                      </div>
                      <p className="text-muted-foreground">
                        {t("dashboard.credibilityDesc")}
                      </p>
                    </div>
                    <div className="text-center p-4 bg-primary/5 rounded-lg">
                      <div className="font-semibold text-primary mb-2">
                        {t("dashboard.portfolioReady")}
                      </div>
                      <p className="text-muted-foreground">
