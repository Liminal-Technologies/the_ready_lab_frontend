...
const MobileBottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-neutral-200 lg:hidden transition-colors duration-200">
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 h-full flex-1 rounded-lg mx-0.5 transition-all ${
                active
                  ...
                  : "text-neutral-600 hover:bg-neutral-100:bg-neutral-800 hover:text-neutral-900:text-white"
              }`}
            >
