          ...
          items.map((item) => (
            <TableRow key={item.id}>
              ...
              <TableCell className="text-sm text-muted-foreground">
                {item.metrics?.enrollments &&
                  `${item.metrics.enrollments} enrolled`}
                {item.metrics?.downloads &&
                  `${item.metrics.downloads} downloads`}
                {item.metrics?.attendees &&
                  `${item.metrics.attendees} attendees`}
