...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "50% platform fee (you keep 50%)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "20% platform fee (you keep 80%)", included: true },
      { text: "Live streaming & events", included: true },
  ...
  },
  {
    ...
    features: [
      { text: "Unlimited courses & products", included: true },
      { text: "10% platform fee (you keep 90%)", included: true },
