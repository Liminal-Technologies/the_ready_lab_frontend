      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-blue-600 font-semibold uppercase tracking-wider text-sm">STUDENT PLANS</span>
          </div>
          <h2 className="text-3xl font-bold text-foreground mb-3">
            For Entrepreneurs Ready to Learn and Grow
          </h2>
          <p className="text-muted-foreground mb-4">
            Access free courses and tools, plus premium learning paths and certifications
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <h3 className="font-semibold text-blue-800 mb-3">🎓 Certification Credibility:</h3>
          <p className="text-sm text-blue-800 mb-2">
            All certifications are industry-recognized and include verified digital badges that can be shared on LinkedIn, resumes, and professional profiles.
          </p>
        </div>
        ...
        <div className="bg-muted/50 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>• Pay in full or split payments via <a href="https://klarna.com" className="text-primary hover:underline">Klarna</a>, <a href="https://afterpay.com" className="text-primary hover:underline">Afterpay</a>, or <a href="https://affirm.com" className="text-primary hover:underline">Affirm</a></li>
            <li>• Workforce development sponsorships and scholarships accepted (if eligible)</li>
          </ul>
        </div>
      </div>
