  ...
  const paymentMethods = [
    {
      ...
      title: "Free Access",
      description:
        "Many courses and tools available at no cost to get you started",
      color: "free",
    },
    {
      icon: CreditCard,
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Free courses available, plus flexible payment options for premium
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {paymentMethods.map((method, index) => {
            ...
            return (
              <Card
                key={index}
                className={`border-2 ${getColorClasses(method.color)} transition-all duration-300 hover:shadow-lg`}
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`w-12 h-12 rounded-xl mx-auto mb-4 flex items-center justify-center ${getIconColorClasses(method.color)}`}
                  >
