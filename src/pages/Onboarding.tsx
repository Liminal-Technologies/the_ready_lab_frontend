...
import { ArrowRight, ArrowLeft, Check, Target, Lightbulb, Users } from 'lucide-react';
...
const Onboarding = () => {
  ...
  const experienceLevels = [
    { value: 'beginner', label: 'Just Starting Out', description: 'New to entrepreneurship' },
    { value: 'intermediate', label: 'Building My Business', description: '1-3 years experience' },
    { value: 'advanced', label: 'Scaling & Growing', description: '3+ years experience' }
  ];
