      ...
      <main className="container mx-auto px-4 pt-24 pb-8 max-w-5xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Find new lessons and resources tailored to your interests
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <PollCard
                  ...
                  options={[
                    ...
                    {
                      id: "3",
                      text: "Understanding complex topics",
                      votes: 28,
                    },
                    ...
                    return (
                      <div key={lesson.id} className="relative">
                        <LessonCard
                          ...
                          trackTitle={
                            lesson.module?.track?.title || "Unknown Track"
                          }
