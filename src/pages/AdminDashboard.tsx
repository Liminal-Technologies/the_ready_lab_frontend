...
export const AdminDashboard = () => {
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case 'educator': return 'bg-accent text-accent-foreground';
            ...
            <div>
              ...
              <div className="flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>{analytics.totalUsers.toLocaleString()} total users</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-success">+{analytics.monthlyGrowth.users}% this month</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-success">{analytics.activeSubscriptions}</div>
              <p className="text-sm text-success">+{analytics.monthlyGrowth.subscriptions}% this month</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-success">+{analytics.monthlyGrowth.revenue}% this month</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-warning">{analytics.pendingApprovals}</div>
              <p className="text-sm text-muted-foreground">Educator applications</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="users" className="space-y-6">
          ...
          <TabsContent value="users" className="space-y-6">
            ...
            <div className="grid gap-4">
              {users.map((user) => (
                <Card key={user.id} className="group hover:shadow-medium transition-all duration-300">
              ...
              <Card className="border-warning/20">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {users.filter(u => u.role === 'educator' && u.status === 'pending').map((educator) => (
                      <div key={educator.id} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-success">$47,230</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span>Certification Purchases</span>
                      <span className="font-semibold text-success">$23,450</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span>Course Sales</span>
                      <span className="font-semibold text-success">$57,170</span>
                    </div>
                    <hr />
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Institutional Licensing Portal</h3>
                  <p className="mb-4">Manage 100-500 user licenses for educational institutions and corporations</p>
