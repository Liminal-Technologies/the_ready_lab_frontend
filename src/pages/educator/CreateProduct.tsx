...
export default function CreateProduct() {
  ...
  const handlePublish = () => {
    ...
    if (!formData.title || !formData.description || !formData.price || !formData.category || !productFile) {
      toast({
        title: "Missing Information",
        description: "Please fill in all required fields and upload a product file.",
        variant: "destructive",
      });
      return;
    }
    ...
    <div className="min-h-screen bg-background py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Create and publish your digital product for students</p>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter information about your digital product</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Price range: $5 - $500</p>
                </div>
                  ...
                  <div className="border-2 border-dashed border-border rounded-lg p-6 text-center hover:border-primary/50 transition-colors">
                    ...
                    <label htmlFor="productFile" className="cursor-pointer">
                      ...
                      {productFile ? (
                        ...
                        <>
                          <p className="text-sm font-medium">Click to upload product file</p>
                          <p className="text-xs text-muted-foreground mt-1">PDF, DOCX, XLSX, ZIP (max 50MB)</p>
                        </>
                      )}
                    </label>
                  </div>
            ...
            <div className="flex gap-4">
              ...
              <Button onClick={handlePublish} className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-black">
                Publish Product
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>How your product will appear in the marketplace</CardDescription>
              </CardHeader>
              <CardContent>
