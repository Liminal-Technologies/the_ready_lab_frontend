...
export function AdminInstitutions() {
  ...
  const filterInstitutions = () => {
    ...
    if (statusFilter !== "all") {
      filtered = filtered.filter(
        (institution) => institution.status === statusFilter,
      );
    }
  ...
  const getPaymentBadge = (paymentStatus: string) => {
    ...
    return (
      <Badge
        className={
          colors[paymentStatus as keyof typeof colors] ||
                  ...
                  <TableBody>
                    {filteredInstitutions.map((institution) => (
                      <TableRow key={institution.id}>
                        ...
                        <TableCell>
                          {getSeatUtilization(
                            institution.seats_used,
                            institution.seat_limit,
                          )}
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          {getPaymentBadge(institution.payment_status)}
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  exportInstitutionData(institution.id)
                                }
                              >
        ...
        <TabsContent value="reports">
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">
                Detailed usage analytics and reporting features coming soon...
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="billing">
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">
                Enterprise billing and invoicing features coming soon...
              </p>
            </CardContent>
          </Card>
        </TabsContent>
